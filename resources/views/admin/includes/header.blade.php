...
<head>
    ...
    <title>@yield('title', 'Fromme - Vendor Dashboard')</title>
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index-2.html">
                        <img src="/admin/assets/img/logo.svg" class="navbar-logo" alt="logo">
                    </a>
                </li>
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                        ...
                        <div class="">
                            ...
                            <a class="dropdown-item">
                                <div class="">
                                    <div class="media">
                                        <div class="user-img">
                                            <img src="/admin/assets/img/profile-15.jpg" class="img-fluid mr-2" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <div class="">
                ...
                <li class="nav-item dropdown user-profile-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <img src="/admin/assets/img/profile-16.jpg" alt="avatar">
                    </a>
