                                ...
                                <tbody>
                                        ...
                                        <td class="product-thumbnail">
                                            <figure>
                                                <a href="product-simple.html">
                                                    <img src="/users/images/products/product18.jpg" width="100" height="100"
                                                        alt="product">
                                                </a>
                                            </figure>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <figure>
                                                <a href="product-simple.html">
                                                    <img src="/users/images/products/product19.jpg" width="100" height="100"
                                                        alt="product">
                                                </a>
                                            </figure>
                                ...
                                <div class="summary mb-4">
                                    ...
                                    <div class="shipping-address">
                                        ...
                                        <div class="select-box">
                                            <select name="country" style="height: 10px;" class="form-control">
